...
use lib::domain::validation::constraints::{
    self, ConstraintVec,
};

pub use self::is_suitable_url::IsSuitableUrl;

pub static EMAIL_CONSTRAINTS: LazyLock<
    ConstraintVec<String>,
> = LazyLock::new(|| {
    ConstraintVec::new()
        .add_constraint(
            constraints::length::Min::with_err(
                |_, limit| {
                    format!(
        ...
        .add_constraint(
            constraints::length::Max::with_err(
                |_, limit| {
                    format!(
...
pub static PASSWORD_CONSTRAINTS: LazyLock<
    ConstraintVec<String>,
> = LazyLock::new(|| {
    ConstraintVec::new()
        .add_constraint(
...
pub static URL_CONSTRAINTS: LazyLock<
    ConstraintVec<String>,
> = LazyLock::new(|| {
    ConstraintVec::new()
        .add_constraint(
