...
#[derive(
    Mapper, Deserialize, Serialize, ToSchema, Default, Debug,
)]
...
pub struct UserTargetSettingsDto {
    ...
    /// регистр может быть разным. Страна с данным кодом
...
impl Parseable<UserTargetSettings>
    for UserTargetSettingsDto
{
